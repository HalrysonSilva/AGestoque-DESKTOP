object DataModule1: TDataModule1
  ...
  object frxDBCAB: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'STATUS=STATUS')
    DataSource = formcontaestoque.DSQRYHISTORICO
    BCDToCurrency = False
    Left = 944
    Top = 376
  end
  ...
  object QRYALTERAPRECOS: TUniQuery
    Connection = ConDados
    SQL.Strings = (
      '-- SQL para DataModule1.QRYALTERAPRECOS'
      'UPDATE TabEst1 SET'
      '    -- Pre'#231'os Varejo'
      ...
      '    '
      '    -- Campos de Auditoria de Pre'#231'o (NOVOS)'
      
        '    UltDtPreco = GETDATE(),            -- Atualiza a data da alt' +
        'era'#231#227'o'
      
        '    LkUsuarioAltPreco = :LkUsuario,   -- Usu'#225'rio que fez a alter' +
        'a'#231#227'o'
      '    '
      '    -- Campos de Auditoria Geral (Mantidos)'
      
        '    DtAlteracao = GETDATE(),          -- Data da Altera'#231#227'o Geral' +
        ' do Cadastro'
      
        '    LkUsuario = :LkUsuario            -- Usu'#225'rio da Altera'#231#227'o Ge' +
        'ral do Cadastro'
      ''
